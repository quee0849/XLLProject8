...
{
XLRegistration::Arg
BSDeltaWithParamsArgs[]=
{
{ "parametersMatrix","too lazy to comment this one ","XLF_OPER"}
};
  XLRegistration::XLFunctionRegistrationHelper
registerBSDeltaWithParams("xlBSDeltaWithParams",
"BSDeltaWithParams",
" Return the delta of vanilla call given spot, strike, r, d, vol, expiry ",
LibraryName,
BSDeltaWithParamsArgs,
1
,false
...
{
XLRegistration::Arg
BSDeltaWithParamsFDArgs[]=
{
{ "parametersMatrix","too lazy to comment this one ","XLF_OPER"},
{ "epsilon","too lazy to comment this one ","B"}
};
  XLRegistration::XLFunctionRegistrationHelper
registerBSDeltaWithParamsFD("xlBSDeltaWithParamsFD",
"BSDeltaWithParamsFD",
" Return the delta of vanilla call given spot, strike, r, d, vol, expiry, epsilon using FD method ",
LibraryName,
BSDeltaWithParamsFDArgs,
2
,false
